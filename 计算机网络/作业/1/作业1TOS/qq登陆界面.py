...
class MyApp(Tkinter.Frame):
    ...
    def __init__(self, master):
        ...
        self.quitButton1 = Tkinter.Button(self, text="Quit1", command=self.create_quit_window)
        self.quitButton1.pack()
        self.quitButton2 = Tkinter.Button(self, text="Quit1", command=self.create_quit_window)
        self.quitButton2.pack()
        self.quitButton3 = Tkinter.Button(self, text="Quit1", command=self.create_quit_window)
        self.quitButton3.pack()
        self.quitButton4 = Tkinter.Button(self, text="Quit1", command=self.create_quit_window)
        self.quitButton4.pack()
        self.quitButton11 = Tkinter.Button(self, text="Quit1", command=self.create_quit_window)
        self.quitButton11.pack()
        self.quitButton21 = Tkinter.Button(self, text="Quit1", command=self.create_quit_window)
        self.quitButton21.pack()
        self.quitButton31 = Tkinter.Button(self, text="Quit1", command=self.create_quit_window)
        self.quitButton31.pack()
        self.quitButton41 = Tkinter.Button(self, text="Quit1", command=self.create_quit_window)
