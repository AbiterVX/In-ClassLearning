...
public:
	void SelectMode();
private:
	void JointsTraverse(Joint *CurrentJoint);
	void JointsTraverse2(Joint *CurrentJoint);
	void SkeletonTraverse(Joint *CurrentJoint);
	void BindWorld_Recursive(Joint *CurrentJoint);
	void CurrentWorld_Recursive(Joint *CurrentJoint);
	Matrix4f *LastJoint;
	int Count = 0;
private:
