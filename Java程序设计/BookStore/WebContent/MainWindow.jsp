...
<jsp:include page="/Initial"></jsp:include>
<%
int Current=1;
Current=(int)session.getAttribute("Mindex");
%>
...
%>
	<div id="header" style="background-color:#FF7F50;">
		...
		if(id !=null)
		{
			out.println("<div style=\"float:right;font-size:25px\"><a href=\"/BookStore/UserSpace.jsp\">"+"User:"+username+"</a></div>"); 			
		}
		else
		{
			out.println("<div style=\"float:right;font-size:25px\"><a href=\"/BookStore/SignIn.jsp\">SignIn</a></div>"); 
		}
		%>
		...
		<div class="MainContent">		
			...
			<div class="Page">
				<form action=PageTurning method="post">
					...
					<input type="hidden" name="jump" value="MainWindow" ></input>
